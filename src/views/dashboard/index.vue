<template>
  <div class="dashboard-container">
      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            ...
            <p class="lastChild">{{ name }}:{{ user.company }}-{{ user.departmentName }}</p>
          </div>
        </div>
        <div class="fr" />
      </div>
    ...
    >
      <el-form ref="ruleForm" label-position="right" label-width="150px" :model="ruleForm" :rules="rules">
        ...
        <el-form-item label="离职原因" prop="reason">
          <el-input v-model="ruleForm.reason" type="textarea" style="width:400px" />
        </el-form-item>
...
import workCaldendar from './components/work-caldendar.vue'
  ...
  data() {
    return {
      ...
      rules: {
        ...
        exceptTime: [{ required: true, message: '请输入时间', trigger: 'blur' }]
      }
    }
  },
  ...
  methods: {
    btnOk() {
      this.$refs.ruleForm.validate(async(val) => {
        if (val) {
          const data = { ...this.ruleForm, userId: this.user.userId, username: this.user.username }
